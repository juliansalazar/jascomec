...
// Return a bio from Julian for his e cv
// And state a service for pricing purposes
...
const Home = () => {
  return (
    <div className='home-banner'>
      <h1>Hi. I'm Julian.</h1>
      <p>I'm an economist with a passion for finance, technology and business.</p>
      ...
      <p>Ready to start your journey with us? Let's get in touch.</p>
      {/* Add services */}
      {/* Add contact form */}
      {/* Add skills */}
      {/* Add portfolio */}
      ...
      <br />
      <h3>Glossary:</h3>
      <p>Total Demand (TD): Product from Price and Quantity of Sales measured in $ US Dollars.</p>
    </div>
  )
}
